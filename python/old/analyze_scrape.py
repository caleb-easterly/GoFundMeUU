...
# examine end of file (todo-read file in chunks for filtering)
df = pd.read_csv("results_11.12.22\\walk_soft\\scraped.csv", skiprows = 2200000)
df.to_csv("results_11.12.22\\walk_soft\\scraped_tail.csv", index=False, line_terminator="\n", encoding="utf-8")
